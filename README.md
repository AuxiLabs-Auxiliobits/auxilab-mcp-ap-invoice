# auxilab-mcp-ap-invoice

> MCP Server · AP invoice field extraction, duplicate detection, vendor normalisation, and payment terms calculation
...
```bash
# Clone the repo
git clone https://github.com/AuxiLabs-Auxiliobits/auxilab-mcp-ap-invoice.git
